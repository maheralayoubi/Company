...
<html lang="en">
  ...
  <body>
    <!-- Ghaith Animation Start
     ...
     <div class="kuro-main" id="kuro-main"><div class="kuro-wrapper"><div class="kuro-letters" id="kuro-letters"><svg viewBox="0 0 432 90"><polygon
               class="st0"
 ...
 C392.26,48.15,389.21,49.12,386.66,49.12z"
             /><rect id="rect" x="0" y="0" width="88" height="90" fill="#111111"><animate
                 attributeType="XML"
                 attributeName="width"
                 from="100"
                 to="0"
                 ...
                 dur="1s"
                 fill="freeze"
               /></rect><rect id="rect" x="110" y="0" width="83" height="90" fill="#111111"><animate
                 attributeType="XML"
                 attributeName="width"
                 from="100"
                 to="0"
                 ...
                 dur="1s"
                 fill="freeze"
               /></rect><rect id="rect" x="196" y="0" width="70" height="90" fill="#111111"><animate
                 attributeType="XML"
                 attributeName="width"
                 from="100"
                 to="0"
                 ...
                 dur="1s"
                 fill="freeze"
               /></rect><rect id="rect" x="277" y="0" width="70" height="90" fill="#111111"><animate
                 attributeType="XML"
                 attributeName="width"
                 from="100"
                 to="0"
             ...
             ><animate
                 ...
                 dur="1s"
                 fill="freeze"
               /></rect></svg></div><div class="zeros" id="zeros"><h1 data-text="#">#</h1><h1 data-text="0">0</h1><h1 data-text="0">0</h1><h1 data-text="0">0</h1><h1 data-text="0">0</h1><h1 data-text="0">0</h1><h1 data-text="0">0</h1></div><div class="kuro-hashtag" id="hashtag">#</div><div class="numbers-letters" id="numbers-letters"><div class="F-letters" id="F-letters">FFFFFF</div><div class="kuro-animation" id="kuro-animation">111111</div><div class="two-numbers">222222</div><div class="three-numbers">333333</div><div class="four-numbers">444444</div><div class="five-numbers">555555</div><div class="six-numbers">666666</div><div class="seven-numbers">777777</div><div class="eight-numbers">888888</div><div class="nine-numbers">999999</div><div class="A-letters">AAAAAA</div><div class="B-letters">BBBBBB</div><div class="C-letters">CCCCCC</div><div class="D-letters">DDDDDD</div><div class="E-letters">EEEEEE</div><div class="F-letters">FFFFFF</div></div></div></div>
    ...
    <nav class="nav slideInLeft" id="lef-nav">
      ...
      <div class="language">
        <p>
          <a style="opacity: 0.3;" href="../index.php">JP</a>/EN/ <a style="opacity: 0.3;" href="../ara/index.php">AR</a>
        </p>
      </div>
      <br>
      <div class="footer">
    ...
    <div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="background-color:#333333!important; margin-top:46px;">
      ...
      <div class="language-sp">
        <p>
          <a style="opacity: 0.3;" href="../index.php">JP</a>/EN
          <!-- /<a style="opacity: 0.3;" href="../ara/index.php">AR</a>-->
        </p>
      </div>
    </div>
    <section class="panel b-blue" id="1">
      <article class="panel__wrapper">
        ...
        <a class="about-link" href="https://kuro-works.com/about">
          <button class="first-sec-button fadeIn">More details</button>
        </a>
        <p class="first-sec-text-two fadeIn">NEWS&nbsp;&nbsp; <span class="news-line"></span>
        </p>
    ...
    <section class="panel b-yellow" id="2">
      <article class="panel__wrapper_two">
        <div class="panel__content_two">
          <p class="first-sec-text-two slider-title-sp">SERVICE&nbsp;&nbsp; <span style="width:77%" class="news-line"></span>
          </p>
          <div class="slideshow-container">
            <div class="mySlides fade">
              ...
              <div class="text">
                ...
                <div class="slider-text">
                  <p>There are tons of design fads out there, <br> but we create a website that matches <br> the client's demands from the planning stage, <br> the design proposal, and through to the <br> implementation and application. </p>
                  <div class="btn">
                    <a href="#">Learn More</a>
                  </div>
                </div>
            ...
            <div class="mySlides fade">
              ...
              <div class="text">
                <h2>PRINT</h2>
                <div class="slider-text">
                  <p>We can also handle leaflets, pamphlets, <br> booklets, and other print materials. <br> We can offer proposals for materials and <br> special printing in accordance to your application. </p>
                  <div class="btn">
                    <a href="#">Learn More</a>
                  </div>
                </div>
            ...
            <div class="mySlides fade">
              ...
              <div class="text">
                <h2>OTHER</h2>
                <div class="slider-text">
                  <p>Please consult with us about any creative <br> materials including illustration, <br> video shooting, video production, photography, <br> model assignment, and advertising banners. </p>
                  <div class="btn">
                    <a href="#">Learn More</a>
                  </div>
                </div>
          ...
          <div id="contactForm">
            ...
            <form class="form" method="post" action="#contactForm">
              <div class="form_input">
                ...
                <input type="text" id="name" name="name" placeholder="Name" maxlength="30" value="
																																													<?php if (!empty($name)) {echo $name;} ?>">
              </div>
              <br>
              <div class="form_input">
                <label for="mail">Email address * required <span class="error"> <?php if (!empty($mailErr)) {echo $mailErr;} ?> </span>
                </label>
                <input type="text" id="mail" name="mail" placeholder="Email address * required" maxlength="50" value="
																																															<?php if (!empty($mail)) {echo $mail;} ?>">
              </div>
              <br>
              <div class="form_input">
                <label for="mailCheck">Email address (confirmation) * required <span class="error"> <?php if (!empty($mailCheckErr)) {echo $mailCheckErr;} ?> </span>
                </label>
                <input type="text" id="mailCheck" name="mailCheck" placeholder="E-mail address (confirmation) * required" maxlength="50" value="
																																																	<?php if (!empty($mailCheck)) {echo $mailCheck;} ?>">
              </div>
              <br>
              <div class="form_input">
                <label for="message">Inquiry details *required <span class="error"> <?php if (!empty($messageErr)) {echo $messageErr;} ?> </span>
                </label>
                <textarea style="height:100px" type="text" id="message" name="message" placeholder="Inquiry details *required" maxlength="500" value="
