...
C392.26,48.15,389.21,49.12,386.66,49.12z" />
    ...
    <nav class="nav slideInLeft" id="lef-nav">
      ...
      <div class="language">
        <p> JP/ <a style="opacity: 0.3" href="eng/index.php">EN</a>
          <!--/<a
            style="opacity: 0.3"
            href="ara/index.php"
            >AR</a
    ...
    <div id="navDemo" class="w3-bar-block w3-black w3-hide w3-hide-large w3-hide-medium w3-top" style="background-color: #333333 !important; margin-top: 46px">
      ...
      <div class="language-sp">
        <p> JP/ <a style="opacity: 0.3" href="eng/index.php">EN</a>/ <a style="opacity: 0.3" href="ara/index.php">AR</a>
        </p>
      </div>
    </div>
    ...
    <section class="panel b-yellow fadeIn" id="2">
      <article class="panel__wrapper_two fadeIn">
        <div class="panel__content_two">
          <p class="first-sec-text-two slider-title-sp"> SERVICE&nbsp;&nbsp; <span style="width: 77.5%" class="news-line"></span>
          </p>
          ...
          <div id="contactForm">
            ...
            <form class="form" method="post" action="#contactForm">
              ...
              <div class="form_input">
                ...
                <input type="text" id="mail" name="mail" placeholder="mail" maxlength="50" value="
																				<?php if (!empty($mail)) {echo $mail;} ?>" />
              </div>
              <br />
              <div class="form_input">
                <label for="mailCheck">メールアドレス(確認) ※必須 <span class="error"> <?php if (!empty($mailCheckErr)) {echo $mailCheckErr;} ?> </span>
                </label>
                <input type="text" id="mailCheck" name="mailCheck" placeholder="メールアドレス" maxlength="50" value="
																					<?php if (!empty($mailCheck)) {echo $mailCheck;} ?>" />
              </div>
              <br />
              <div class="form_input">
                <label for="message">お問い合わせ内容 ※必須 <span class="error"> <?php if (!empty($messageErr)) {echo $messageErr;} ?> </span>
                </label>
                <textarea style="height: 100px" type="text" id="message" name="message" placeholder="お問い合わせ内容" maxlength="500" value="
