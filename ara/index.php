																		...
																		<nav class="nav slideInLeft" id="lef-nav">
																			<div class="burger">
																				<img src="../logo.png" alt="">
																					...
																					<div class="language">
																						<p>
																							<a style="opacity: 0.3;" href="../index.php">JP</a>/
																							<a style="opacity: 0.3;" href="../eng/index.php">EN</a>/AR
																						</p>
																					</div>
																					<br>
																						<div class="footer">
																									...
																									<img class="zero-image fadeInLeft" src="../zero.png" alt="">
																										<img class="arrow-image fadeInLeft" src="../arrow.png" alt="">
																											...
																											<div class="first-img-sec-sp">
																												...
																												<a class="about-link" href="http://kuro-works.com/sub-link/index.php/about-ara/">
																													<button class="first-sec-button fadeIn">المزيد من التفاصيل</button>
																												</a>
																												<p class="first-sec-text-two fadeIn">أخبار&nbsp;&nbsp;
																													<span style="width:355px;" class="news-line"></span>
																												</p>
																										...
																										<section class="panel b-yellow" id="2">
																											<article class="panel__wrapper_two">
																												<div class="panel__content_two">
																													<p class="first-sec-text-two slider-title-sp">الخدمات&nbsp;&nbsp;
																														<span style="width:83%" class="news-line"></span>
																													</p>
																															...
																															<img class="slider-img" src="../pc_service_info_1.png" style="width:100%">
																																<div class="text">
																																	...
																																	<div class="slider-text slide-text-ara">
																																		<p>هناك العديد من البدع التصميم هناك
																																			<br>
                        لكننا ننشئ موقع ويب يطابق
																																				<br>
                        مطالب العميل من مرحلة التخطيط
																																					<br>
                        اقتراح التصميم ، وحتى
																																						<br>
                        التنفيذ والتطبيق
																																			...
																																			<div class="mySlides fade">
																																				<img class="slider-img" src="../pc_service_info_2.png" style="width:100%">
																																					<div class="text">
																																						<h2>PRINT</h2>
																																						<div class="slider-text slide-text-ara">
																																							<p>يمكننا أيضا التعامل مع المنشورات والنشرات
																																								<br>
                      الكتيبات والمواد المطبوعة الأخرى
																																									<br>
                      يمكننا تقديم مقترحات للمواد و
																																										<br>
                      الطباعة الخاصة وفقا لطلبك
																																										</p>
																																										<div class="btn">
																																											<a href="#">Learn More</a>
																																										</div>
																																							...
																																							<div class="mySlides fade">
																																								<img class="slider-img" src="../pc_service_info_3.png" style="width:100%">
																																									<div class="text">
																																										<h2>OTHER</h2>
																																										<div class="slider-text slide-text-ara">
																																											<p>يرجى التشاور معنا حول أي
																																												<br>
                        العمل بما في ذلك التوضيح
																																													<br>
                        تصوير الفيديو ، إنتاج الفيديو ، التصوير الفوتوغرافي
																																														<br>
                        نموذج المهمة ، واللافتات الإعلانية
																																														</p>
																																														<div class="btn">
																																															<a href="#">Learn More</a>
																																														</div>
																																											...
																																											<a class="next" onclick="plusSlides(1)">
																																												<svg
																																													xmlns="http://www.w3.org/2000/svg" class="next-icon" width="55.56" height="106.56" viewBox="0 0 55.56 106.56">
																																													<defs>
																																														<style>
                      .cls-1 {
                        fill: #e0e0e0;
																																								...
																																								<article class="panel__wrapper_three">
																																									<div class="panel__content_three">
																																										<div class="third-sec-images">
																																											<p class="first-sec-text-two works-title-sp">أعمال&nbsp;&nbsp;
																																												<span class="news-line works-line"></span>
																																											</p>
